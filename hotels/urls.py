...
urlpatterns = [
    ...
    path('all/', views.view_hotels_unregistered, name="view_hotels_unregistered"),
    path('search/', views.search_hotels_unregistered, name="search_hotels_unregistered"),
    path('book/all/', views.view_hotels, name="view_hotels"),
    path('book/search/', views.search_hotels, name="search_hotels"),
